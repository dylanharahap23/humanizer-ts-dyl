...
console.log("Is comprehensive neutral:", (0, humanizer_1.isComprehensiveNeutralExplanation)(comprehensiveText));
...
console.log("Is comprehensive neutral:", (0, humanizer_1.isComprehensiveNeutralExplanation)(personalText));
console.log("Expected: false\n");
// Test 3: Selective rewrite prompt exists
console.log("Test 3: Selective rewrite prompt");
console.log("Prompt length:", humanizer_1.SELECTIVE_REWRITE_PROMPT.length);
console.log("Contains 'selectively':", humanizer_1.SELECTIVE_REWRITE_PROMPT.includes('selectively'));
console.log("Contains 'discarding':", humanizer_1.SELECTIVE_REWRITE_PROMPT.includes('discarding'));
console.log("Contains 'rhetorical question':", humanizer_1.SELECTIVE_REWRITE_PROMPT.includes('rhetorical question'));
console.log("Contains 'specific number':", humanizer_1.SELECTIVE_REWRITE_PROMPT.includes('specific number') || humanizer_1.SELECTIVE_REWRITE_PROMPT.includes('number, year, or name'));
console.log();
...
const enhanced = (0, humanizer_1.injectHumanSpecifics)(plainText, sourceWithSpecifics);
